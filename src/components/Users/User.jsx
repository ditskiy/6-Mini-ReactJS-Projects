...
export const User = ({id, email, first_name, last_name, avatar, onClicInvait, isInvaite}) => (
  <li>
    <div>
    ...
    <img onClick={() => onClicInvait(id)} className="action" src={`/assets/${isInvaite ? "minus" : "plus"}.svg`} alt="Action" />
  </li>
);
